    ...
    <div className={styles.pageRoot}>
      <div className={styles.content} style={{ maxWidth: 520, margin: '0 auto' }}>
        <div className={styles.panel}>
          <div className={styles.panelTitle}>Admin Login</div>
          <div className={styles.subtle}>Use your admin email/password.</div>
          <div style={{ height: 12 }} />
          ...
          <div style={{ height: 10 }} />
          <div className={styles.row}>
            <input className={styles.input} style={{ flex: 1 }} placeholder="Password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} />
          </div>
          {error ? <div style={{ marginTop: 10, color: '#b91c1c', fontWeight: 650 }}>{error}</div> : null}
          <div style={{ height: 12 }} />
          <div className={styles.row}>
            <button
              type="button"
